export function createJsonState(sourceData) {
	return { report: '', error: '', remainder: sourceData.trim() };
}
...
export const tokenValidators = {
	...
	ARRAY_1: { validTokens: ['Array closure', 'Comma'], action: CLOSE_CONTEXT },
	ARRAY_2: {
	...
	OBJECT_3: { validTokens: ['Object closure', 'Comma'], action: CLOSE_CONTEXT },
